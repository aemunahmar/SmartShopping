...
<html>
    ...
    <body>
        ...
        <section>
            <h1 id = "page_title">Click on a brand to see all user reviews</h1>
        </section>
        
        <nav class = "brands_title">
            <ul>
                <li><a href = "american_eagle_reviews.php">American Eagle</a></li>
            </ul>
        </nav>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM brandreviews LIMIT 10 OFFSET 40";
            $result = mysqli_query($dbconnect, $query);

            //Set Array
            $array = array();
            $americanReviews = array();
            ...
            { 
                ...
                { 
                    ...
                    {
                        if($array[$i]['brand'] == "American Eagle Outfitters")
                        {
                            $americanReviews[$i] = $array[$i];
                        }
                    }
                } 
            }
        ...
        <section id = "all-reviews">
            <div class = "reviews-card">
                <div class = "reviews-card_details">
                    <div class = "reviews-card_name"><?php echo $americanReviews[$j]['name'];?></div>
                    <div class = "reviews-card_review"><?php echo $americanReviews[$j]['review']; $j++;?></div>    
                </div>
            </div>
            <div class = "reviews-card">
                <div class = "reviews-card_details">
        ...
        <nav class = "brands_title">
            <ul>
                <li><a href = "asos_reviews.php">ASOS</a></li>
            </ul>
        </nav>
        
        <?php
            //Set Database Query
            $query = "SELECT * FROM brandreviews LIMIT 10 OFFSET 10";
            $result = mysqli_query($dbconnect, $query);
            ...
            { 
                ...
                { 
                    ...
                    for($i = 0; $i < sizeof($array); $i++)
                    {
                        if($array[$i]['brand'] == "ASOS")
                        {
                            $asosReviews[$i] = $array[$i];
                        }
                    }
                } 
            }
        ...
        <section id = "all-reviews">
            <div class = "reviews-card">
                <div class = "reviews-card_details">
                    <div class = "reviews-card_name"><?php echo $asosReviews[$j]['name'];?></div>
                    <div class = "reviews-card_review"><?php echo $asosReviews[$j]['review']; $j++;?></div>    
                </div>
            </div>
            <div class = "reviews-card">
                <div class = "reviews-card_details">
        ...
        <nav class = "brands_title">
            <ul>
                <li><a href = "forever21_reviews.php">Forever 21</a></li>
            </ul>
        </nav>
        
        <?php
            //Set Database Query
            $query = "SELECT * FROM brandreviews LIMIT 10";
            $result = mysqli_query($dbconnect, $query);

            //Set Array
            $array = array();
            $foreverReviews = array();
            ...
            { 
                ...
                { 
                    ...
                    for($i = 0; $i < sizeof($array); $i++)
                    {
                        if($array[$i]['brand'] == "Forever 21")
                        {
                            $foreverReviews[$i] = $array[$i];
                        }
                    }
                } 
            }
        ...
        <section id = "all-reviews">
            <div class = "reviews-card">
                <div class = "reviews-card_details">
                    <div class = "reviews-card_name"><?php echo $foreverReviews[$j]['name'];?></div>
                    <div class = "reviews-card_review"><?php echo $foreverReviews[$j]['review']; $j++;?></div>    
                </div>
            </div>
            <div class = "reviews-card">
                <div class = "reviews-card_details">
        ...
        <nav class = "brands_title">
            <ul>
                <li><a href = "h_m_reviews.php">H&M</a></li>
            </ul>
        </nav>
        
        <?php
            //Set Database Query
            $query = "SELECT * FROM brandreviews LIMIT 10 OFFSET 20";
            $result = mysqli_query($dbconnect, $query);
        ...
        <section id = "all-reviews">
            <div class = "reviews-card">
                <div class = "reviews-card_details">
                    <div class = "reviews-card_name"><?php echo $hmReviews[$j]['name'];?></div>
                    <div class = "reviews-card_review"><?php echo $hmReviews[$j]['review']; $j++;?></div>    
                </div>
            </div>
            <div class = "reviews-card">
                <div class = "reviews-card_details">
