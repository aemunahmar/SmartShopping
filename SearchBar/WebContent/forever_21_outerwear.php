...
<html>
    ...
    <body>
        ...
        <section id="products_header">
            ...
            <nav class="products_nav">
                <ul>
                    ...
                    <li><a href="forever_21_bottoms.php">BOTTOMS</a></li>
                    <li id="products_current"><a href="forever_21_outerwear.php">OUTERWEAR</a></li>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM productslist LIMIT 15 OFFSET 45";
