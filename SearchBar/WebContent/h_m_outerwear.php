    ...
    <body>
        <header>
            ...
            <nav  class="nav-bar">
                <ul>
                    ...
                    <li id="current-page"><a href="h_m.php">H&M</a></li>
        ...
        <section id="products_header">
            ...
            <nav class="products_nav">
                <ul>
                    <li><a href="h_m_tops.php">TOPS</a></li>
                    <li><a href="h_m_bottoms.php">BOTTOMS</a></li>
                    <li id="products_current"><a href="h_m_outerwear.php">OUTERWEAR</a></li>
                    <li><a href="h_m_shoes.php">SHOES</a></li>
                </ul>
            </nav>
        </section>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM productslist LIMIT 15 OFFSET 165";
