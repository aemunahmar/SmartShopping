    ...
    <body>
        <header>
            ...
            <nav  class="nav-bar">
                <ul>
                    ...
                    <li id="current-page"><a href="gap.php">GAP</a></li>
        ...
        <section id="products_header">
            ...
            <nav class="products_nav">
                <ul>
                    <li><a href="gap_tops.php">TOPS</a></li>
                    <li><a href="gap_bottoms.php">BOTTOMS</a></li>
                    <li id="products_current"><a href="gap_outerwear.php">OUTERWEAR</a></li>
                    <li><a href="gap_shoes.php">SHOES</a></li>
                </ul>
            </nav>
        </section>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM productslist LIMIT 10 OFFSET 220";
