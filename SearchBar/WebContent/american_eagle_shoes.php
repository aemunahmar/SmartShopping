    ...
    <body>
        ...
        <section id="products_header">
            <div class="product_title">
                ...
                <h3>Select Your Favorite Shoes</h3>
            </div>
            <nav class="products_nav">
                <ul>
                    <li><a href="american_eagle_tops.php">TOPS</a></li>
                    <li><a href="american_eagle_bottoms.php">BOTTOMS</a></li>
                    <li><a href="american_eagle_outerwear.php">OUTERWEAR</a></li>
                    <li id="products_current"><a href="american_eagle_shoes.php">SHOES</a></li>
                </ul>
            </nav>
        </section>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM productslist LIMIT 15 OFFSET 264";
