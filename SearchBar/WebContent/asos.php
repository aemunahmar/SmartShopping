    ...
    <body>
        <header>
            ...
            <nav  class="nav-bar">
                <ul>
                    ...
                    <li id="current-page"><a href="asos.php">ASOS</a></li>
        ...
        <section id="products_header">
            ...
            <nav class="products_nav">
                <ul>
                    <li><a href="asos_tops.php">TOPS</a></li>
                    <li><a href="asos_bottoms.php">BOTTOMS</a></li>
                    <li><a href="asos_outerwear.php">OUTERWEAR</a></li>
                    <li><a href="asos_shoes.php">SHOES</a></li>
                </ul>
            </nav>
        </section>
        ...
        <?php
            ...
            //Set Database Query
            $query = "SELECT * FROM productslist LIMIT 60 OFFSET 60";
            ...
            <ul class = "products-container">
                ...
                <li>
                    <form class = "product-card">
                        <div class = "product-card_image"><?php echo '<a href = "' . $row['url'] . '"><img id = "brandName" alt = "Asos" src = "'. $row['image'] . '"></a>'; ?> 
                        </div>
